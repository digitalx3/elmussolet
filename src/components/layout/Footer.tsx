...
const Footer: React.FC = () => {
  ...
  const about = settings?.[`footer_about_${lang}`] || '🍼 Botiga de Puericultura Física i Online<br/>🌱 Roba de cotó orgànic i bambú<br/>🧸 Llistes de naixement personalitzades';
